...
浏览器打开 **http://127.0.0.1:3000**，默认进入 **「和 新人入职」→ 身份选择**：

- 和字 Logo +「选择你的身份进入对应模块」
- 三张卡片：**我是新人 / 我是导师 / 我是 HR**

手机 H5 试点（无外壳、彩色三门）：`npm run pilot:dingtalk` → http://127.0.0.1:8080

> 若 3000 被占用：`npx vite --port 3002 --host 127.0.0.1 --open /`

演示账号：`E00001` / `123456`（首次）· `E00008`（老员工）
